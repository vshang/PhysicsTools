...
#catSL=("SL2lTR" "SL1lWR")
catSL=("SL1l0fT1SR" "SL1l0fT2SR" "SL1l0fT3SR" "SL1l1fT1SR" "SL1l1fT2SR" "SL1l1fT3SR" "SL1l2bT1SR" "SL1l2bT2SR" "SL1l2bT3SR")
...
for year in ${years[@]}; do
    for cat in ${catAH[@]}; do
    	echo $cat$year
	nohup python plots/plot.py -c ${cat} -y ${year} -p > ${cat}${year}_partialUnblind.out &
