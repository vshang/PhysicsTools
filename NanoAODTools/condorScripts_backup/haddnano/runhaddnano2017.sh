...
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_WminusH_Run2017_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/VH_Run2017/WminusH_WToQQ_HToInvisible_M125_13TeV_powheg_pythia8/ModuleCommonSkim_06102022/tree_all.root
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_WplusH_Run2017_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/VH_Run2017/WplusH_WToQQ_HToInvisible_M125_13TeV_powheg_pythia8/ModuleCommonSkim_06102022/tree_all.root
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_ZH_Run2017_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/VH_Run2017/ZH_ZToQQ_HToInvisible_M125_13TeV_powheg_pythia8/ModuleCommonSkim_06102022/tree_all.root
