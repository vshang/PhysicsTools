...
cat > "${SUBMIT}" << EOF
executable = ./runhaddnano2018_tDM.sh
output = ${RUNDIR}/runhaddnano2018_tDM.stdoutD
error = ${RUNDIR}/runhaddnano2018_tDM.stderr
log = ${RUNDIR}/runhaddnano2018_tDM.condor_log
requestdisk = 200G
requestmemory = 32G
