...
cat > "${SUBMIT}" << EOF
executable = ./runhaddnano2017_tDM.sh
output = ${RUNDIR}/runhaddnano2017_tDM.stdoutD
error = ${RUNDIR}/runhaddnano2017_tDM.stderr
log = ${RUNDIR}/runhaddnano2017_tDM.condor_log
requestdisk = 200G
requestmemory = 32G
