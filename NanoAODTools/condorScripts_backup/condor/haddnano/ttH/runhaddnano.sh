...
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_ttH_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/ttH_Run2016/ttH_HToInvisible_M125_TuneCUETP8M1_13TeV_powheg_pythia8_nanoAODv7/ModuleCommonSkim_12242022/tree_all.root
