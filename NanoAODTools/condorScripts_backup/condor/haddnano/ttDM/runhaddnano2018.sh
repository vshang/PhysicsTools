...
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_ttbardm_10GeV_scalar_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/ttbarDM_Run2018/ttbardm_10GeV_scalar_incl_2018_nanoaod/countEvents_12242022/tree_all.root
env -i X509_USER_PROXY=$X509_USER_PROXY gfal-copy -t 10000 -p tree_ttbardm_10GeV_pseudo_all.root davs://pubxrootd.hep.wisc.edu:1094/store/user/vshang/ttbarDM_Run2018/ttbardm_10GeV_pseudo_incl_2018_nanoaod/countEvents_12242022/tree_all.root
