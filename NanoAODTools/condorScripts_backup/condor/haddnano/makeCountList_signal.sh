...
for FILE in  /hdfs/store/user/vshang/tDM_Run*/*/countEvents_02062024/rootFiles/*Skim.root; do
...
for FILE in  /hdfs/store/user/vshang/ttbarDM_Run*/ttbardm*/countEvents_02062024/rootFiles/*Skim.root; do
...
for FILE in  /hdfs/store/user/vshang/ttH_Run2016/ttH_*nanoAODv7/countEvents_02062024/rootFiles/*Skim.root; do
