...
ttbar1 = 'outDir2016AnalysisSR/ttbarDM/synchro_exercise_2016/ttbarDM_Mchi1Mphi100_scalar_full1'
ttbar2 = 'outDir2016AnalysisSR/ttbarDM/synchro_exercise_2016/ttbarDM_Mchi1Mphi100_scalar_full2'
tChan = 'outDir2016AnalysisSR/tDM_tChan/synchro_exercise_2016/tDM_tChan_Mchi1Mphi100_scalar_full'
tWChan = 'outDir2016AnalysisSR/tDM_tWChan/synchro_exercise_2016/tDM_tWChan_Mchi1Mphi100_scalar_full'
...
h_ttbarSL1b_MT.SetMaximum(1000)
#Add legend
...
if not sameCanvas:
    c1b_MT.SaveAs("plots/SL_optimization/" + date + "/SL1b_MT_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c1b_MT2W.SaveAs("plots/SL_optimization/" + date + "/SL1b_MT2W_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c1b_minDeltaPhi.SaveAs("plots/SL_optimization/" + date + "/SL1b_minDeltaPhi_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c1b_MTb.SaveAs("plots/SL_optimization/" + date + "/SL1b_MTb_histo" + date + ".pdf")
# print("Finished creating SL1b MTb distribution plot")

# #Save SL1b distribution plots on same canvas if desired
# if sameCanvas:
#     c1b.SaveAs("plots/SL_optimization/" + date + "/SL1b_allOptimizations_histo" + date + ".pdf")
...
h_ttbarSL2b_MT = TH1F('h_ttbarSL2b_MT', 'SL2b M_{T}distribution; M_{T} (GeV); Events', 10, 0, 400)
h_tbarSL2b_MT = TH1F('h_tbarSL2b_MT', 'SL2b M_{T} distribution; M_{T} (GeV); Events', 10, 0, 400)
...
if not sameCanvas:
    c2b_MT.SaveAs("plots/SL_optimization/" + date + "/SL2b_MT_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c2b_MT2W.SaveAs("plots/SL_optimization/" + date + "/SL2b_MT2W_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c2b_minDeltaPhi.SaveAs("plots/SL_optimization/" + date + "/SL2b_minDeltaPhi_histo" + date + ".pdf")
...
# if not sameCanvas:
#     c2b_MTb.SaveAs("plots/SL_optimization/" + date + "/SL2b_MTb_histo" + date + ".pdf")
# print("Finished creating SL2b MTb distribution plot")

# #Save SL2b distribution plots on same canvas if desired
# if sameCanvas:
#     c2b.SaveAs("plots/SL_optimization/" + date + "/SL2b_allOptimizations_histo" + date + ".pdf")
