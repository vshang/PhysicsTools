...
saveDirectory = 'plots/systematics/CMS_scale_j/'
...
syshists['bkgSum_sysUp'] += syshists['ttbar scalar_sysUp']
syshists['bkgSum_sysDown'] += syshists['ttbar scalar_sysDown']
...
if savePlots:
    if useCondor:
        ...
        if partialUnblind:
            suffix += '_partialUnblind'
        c.SaveAs(saveDirectory + date + '/' + cut + nameYear + '_' + var.replace('/','over') + '_' + suffix + '_ttDM_scalar_Mchi1_Mphi300.png')
