...
def addSys(histName, eventTree, var, cut, sysName, addHist=True):
    ...
    if 'CMS_res_j' in sysName:
        ...
        cutUp = cut.replace('qcdZTo2LWeight','qcdZTo2LWeightRenUp')
        cutUp = cutUp.replace('qcdZTo2NuWeight','qcdZTo2NuWeightRenUp')
        cutDown = cut.replace('qcdZTo2LWeight','qcdZTo2LWeightRenDown')
        cutDown = cutDown.replace('qcdZTo2NuWeight','qcdZTo2NuWeightRenDown')

    elif sysName == 'CMS_ZqcdWeightFac':
        cutUp = cut.replace('qcdZTo2LWeight','qcdZTo2LWeightFacUp')
        cutUp = cut.replace('qcdZTo2NuWeight','qcdZTo2NuWeightFacUp')
        cutDown = cut.replace('qcdZTo2LWeight','qcdZTo2LWeightFacDown')
        cutDown = cut.replace('qcdZTo2NuWeight','qcdZTo2NuWeightFacDown')
        ...
        cutUp = cut.replace('bjetWeight','bjetWeightbcUpCorrelated')
        cutDown = cut.replace('bjetWeight','bjetWeightbcDownCorrelated')
    
    elif sysName == 'CMS_eff_b_light_corr':
        cutUp = cut.replace('bjetWeight','bjetWeightlightUpCorrelated')
        cutDown = cut.replace('bjetWeight','bjetWeightlightDownCorrelated')

    elif sysname == 'CMS_eff_b_'+str(year):
        cutUp = cut.replace('bjetWeight','bjetWeightbcUpUncorrelated')
        cutDown = cut.replace('bjetWeight','bjetWeightbcDownUncorrelated')

    elif sysname == 'CMS_eff_b_light_'+str(year):
        cutUp = cut.replace('bjetWeight','bjetWeightlightUpUncorrelated')
        cutDown = cut.replace('bjetWeight','bjetWeightlightDownUncorrelated')
        ...
        cutUp = cutUp + '*PSWeightISRUp'
        cutDown = cutDown + '*PSWeightISRDown'

    elif sysName == 'CMS_PSfsr':
        cutUp = cutUp + '*PSWeightFSRUp'
        cutDown = cutDown + '*PSWeightFSRDown'
...
for process in MCSamples:
    for dataset in MCSamples[process]:
        ...
        for filepath in MCSamples[process][dataset]['filepaths']:
            ...
            if (process in signal) and useCentralSamples and ('ttbar' in process) and ('MPhi125_scalar' not in dataset):
