        ...
        for filepath in dataSamples[dataset]['filepaths']:
            ...
            if combineEleMu:
                if dataset == 'SingleMuon':
                    ...
                    datacut = cuts[cut.replace('l','e')] + ' && Flag_eeBadScFilter'
                    if year == 2016:
                        datacut = datacut.replace('HLT_Ele115_CaloIdVT_GsfTrkIdT || HLT_Photon175', '!HLT_Ele115_CaloIdVT_GsfTrkIdT && HLT_Photon175')
                    if year == 2017:
                        datacut = datacut.replace('HLT_Ele115_CaloIdVT_GsfTrkIdT || HLT_Photon200', '!HLT_Ele115_CaloIdVT_GsfTrkIdT && HLT_Photon200')
                else:
