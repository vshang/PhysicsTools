if __name__ == '__main__':
 ...
 ##   User inputs 
 #####
 task          = 'ModuleCommonSkim_06102022' #Name of the task (e.g. Test, SignalRegion, ControlRegion, FullAnalysis, ...)
 ...
 #datasetnames = ['QCDPt']
 datasetnames = ['ttH','ttbarDM','ttbarPlusJets','singleTop','WPlusJets','ZTo2L','ZTo2Nu','WW','WZ','ZZ','TTV','QCD']#,'WPlusJetsNLO','ZTo2LNLO','ZTo2NuNLO']
 #years = ['UL2016']
 #years = ['2016','2017']
