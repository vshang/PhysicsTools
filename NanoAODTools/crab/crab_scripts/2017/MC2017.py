...
p=PostProcessor(".",inputFiles(),cut=None,branchsel=None,modules=[jetmetCorrector2017MC(),analyze2017MC_Skim()],provenance=True,fwkJobReport=True,jsonInput=runsAndLumis(),noOut=False,outputbranchsel="keep_and_dropSR_out.txt")
