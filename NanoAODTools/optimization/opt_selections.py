...
selection = {
    # Hadronic category
    "AH0lSR_1FWJ" : "isZtoNN && MET_pt>250. && nJets>=2 && nBTagJets==1 && nForwardJets>=1",
    "AH0lSR_0FWJ" : "isZtoNN && MET_pt>250. && nJets>=2 && nBTagJets>=1 && nForwardJets==0",
    ...
    "AH1mTR" : "isWtoMN && MET_pt>250. && Lepton1_pt>30. && abs(Lepton1_eta)<2.1 && Lepton1_id==4 && mT<160. && nJets>=3 && nBTagJets>=1  && nElectrons==1 && nMuons==0 && MinDPhi>1.",
    
    # Semileptonic category
    "SL1eSR" : "isWtoEN && nElectrons==1 && nMuons==0 && nTaus==0 && MET_pt>160. && Lepton1_pt>30. && abs(Lepton1_eta)<2.1 && Lepton1_id==4 && nJets>=2 && nBTagJets>=1 && MinDPhi12>1.2 && mT>160. && mT2>200.",
    ...
    "SL1eWR" : "isWtoEN && nElectrons==1 && nMuons==0 && nTaus==0 && MET_pt>160. && Lepton1_pt>30. && abs(Lepton1_eta)<2.1 && Lepton1_id==4 && nJets>=2 && nBTagJets==0 && mT>160. && MinDPhi12>0.4",
    "SL1mWR" : "isWtoMN && nElectrons==0 && nMuons==1 && nTaus==0 && MET_pt>160. && Lepton1_pt>30. && abs(Lepton1_eta)<2.1 && Lepton1_pfIso<0.15 && Lepton1_id==4 && nJets>=2 && nBTagJets==0 && mT>160. && MinDPhi12>0.4",

    "SL1e1mTR" : "(isTtoEM || isZtoMM) && ((nElectrons==1 && nMuons==1) || (nElectrons==0 && nMuons==2)) && nTaus==0 && MET_pt>160. && Lepton1_pt>30. && abs(Lepton1_eta)<2.1 && Lepton1_id==4 && Lepton2_pt>30. && abs(Lepton2_eta)<2.1 && Lepton2_pfIso<0.15 && Lepton2_id==4 && nJets>=2 && nBTagJets>=1",
