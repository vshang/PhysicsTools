...
namespace JetUtil
{
  ...
  //helper function for DeltaPhi, using two TLorentzVector's
  ...
  //helper function for DeltaR, using two TLorentzVector's
  ...
  vector<TLorentzVector > BJetSelector(vector<TLorentzVector > jets, vector<float> btagvalues, float bjetdiscr, unsigned int minbjets, unsigned int minaddbjets, int versionAddjets){
  ...
  vector<int> JetIndexCSVsorted(vector<float> btagvalues, vector<TLorentzVector > jets, vector<bool> jid, float minpt, float maxeta, bool passjid){
