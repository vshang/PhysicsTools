...
to next event)"""
        ...
        Skim = ((nTightElectrons + nTightMuons) <= 1 and njets >= 2 and METcorrected_pt > 200) or ((nTightElectrons + nTightMuons) == 2 and njets >= 2 and (METcorrected_pt > 200 or recoilPtMiss > 200) )
...
if runLocal:
    ...
    p=PostProcessor(outputDir,inputFiles,cut=selection,branchsel=None,modules=[jetmetCorrector2016MC(),analyze2016MC_Skim()],postfix="_ModuleCommon_2016MC_Skimold",noOut=False,outputbranchsel=outputbranches)
