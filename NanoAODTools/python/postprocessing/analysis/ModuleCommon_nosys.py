...
#     inputFiles=["MET_Run2017F.root"]
#     #inputFiles=["Z2JetsToNuNu2017_M-50_LHEZpT_250-400_2DDF7CE3-C72F-3546-9495-FDECC93FEFF2.root"]
...
#     #p=PostProcessor(outputDir,inputFiles,cut=selection,branchsel=None,modules=[jetmetCorrector2017MC(),analyze2017MC_Skim()],postfix="_METcorrectedpTSkim",noOut=False,outputbranchsel=outputbranches)
...
#     p=PostProcessor(outputDir,inputFiles,cut=selection,branchsel=None,modules=[jetmetCorrector2017DataF(),analyze2017Data_Skim()],postfix="_METcorrectedpTSkim",noOut=False,outputbranchsel=outputbranches,jsonInput=jsonFile)
