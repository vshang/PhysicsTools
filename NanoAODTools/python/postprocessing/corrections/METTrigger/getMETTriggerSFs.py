...
if savePlots:
    ...
    hists['1eEffRatio'].Draw('hist')
    hists['1eEffRatio'].SetMinimum(0)
    hists['1eEffRatio'].SetMaximum(1)
    ...
    hists['1mEffRatio'].Draw('hist')
    hists['1mEffRatio'].SetMinimum(0)
    hists['1mEffRatio'].SetMaximum(1)
