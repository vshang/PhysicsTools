...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/blackhat/0.9.9-omkpbe4/include
...
ALL_TOOLS      += boost
boost_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.63.0-gnimlf/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.63.0-gnimlf/include
...
boost_python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/boost/1.63.0-gnimlf/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/bz2lib/1.0.6-omkpbe2/include
bz2lib_EX_LIB := bz2
...
cascade_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cascade/2.2.04-gnimlf2/include
cascade_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += catch2
catch2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/catch2/2.2.2/include
...
ALL_TOOLS      += cgal
cgal_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cgal/4.2-gnimlf2/include
...
ALL_TOOLS      += charybdis
charybdis_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/charybdis/1.003-gnimlf2/include
charybdis_EX_LIB := charybdis
charybdis_EX_USE := root_cxxdefaults f77compiler herwig pythia6

ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/classlib/3.1.3-omkpbe2/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.148/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.148/lib64/stubs
cuda-stubs_EX_FLAGS_SKIP_TOOL_SYMLINKS  := 1

ALL_TOOLS      += cuda
ALL_LIB_TYPES += CUDA_LIB
cuda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/cuda/9.2.148/include
...
ALL_TOOLS      += curl
curl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/curl/7.59.0/include
curl_EX_LIB := curl
...
ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/davix/0.6.7-gnimlf2/include/davix
davix_EX_LIB := davix
davix_EX_USE := boost_system openssl libxml2

ALL_TOOLS      += db6
db6_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/db6/6.0.30-omkpbe2/include
db6_EX_LIB := db

ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dcap/2.47.8-omkpbe2/include
dcap_EX_LIB := dcap
...
ALL_TOOLS      += dd4hep
dd4hep_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dd4hep/v01-08x-gnimlf2/include
dd4hep_EX_LIB := DDAlign DDCore DDCond DDParsers
dd4hep_EX_USE := root_cxxdefaults root boost xerces-c clhep

ALL_TOOLS      += dire
dire_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dire/2.002/include
dire_EX_LIB := dire
...
ALL_TOOLS      += dpm
dpm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dpm/1.8.0.1-omkpbe2/include
dpm_EX_LIB := dpm
dpm_EX_LIBDIR := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/dpm/1.8.0.1-omkpbe2/lib
dpm_EX_USE := root_cxxdefaults

ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/eigen/64060da8461a627eb25b5a7bc0616776068db58b/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/evtgen/1.6.0-gnimlf4/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += expat
expat_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/expat/2.1.0-omkpbe2/include
expat_EX_LIB := expat
expat_EX_USE := root_cxxdefaults

ALL_TOOLS      += fastjet-contrib-archive
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/fastjet-contrib/1.033-omkpbe/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/fastjet-contrib/1.033-omkpbe/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/fastjet/3.3.0-omkpbe/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet
fastjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/fftjet/1.5.0-omkpbe2/include
fftjet_EX_LIB := fftjet
fftjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/fftw3/3.3.2-omkpbe2/include
fftw3_EX_LIB := fftw3
fftw3_EX_USE := root_cxxdefaults

ALL_TOOLS      += freetype
freetype_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/freetype/2.5.3-omkpbe2/include
freetype_EX_LIB := freetype-cms
freetype_EX_USE := root_cxxdefaults

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/frontier_client/2.8.20-omkpbe4/include
frontier_client_EX_LIB := frontier_client
frontier_client_EX_USE := root_cxxdefaults zlib openssl expat python

ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gbl/V02-01-03-gnimlf3/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gdbm/1.10-omkpbe2/include
gdbm_EX_LIB := gdbm
...
geant4core_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/geant4/10.04-gnimlf3/include/Geant4
...
ALL_TOOLS      += giflib
giflib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/giflib/4.2.3-omkpbe2/include
giflib_EX_LIB := gif
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gmp-static/6.1.0-omkpbe2/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
google-benchmark_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/google-benchmark/1.4.x/include
...
gosamcontrib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gosamcontrib/2.0-20150803-omkpbe2/include

ALL_TOOLS      += graphviz
graphviz_EX_USE := expat zlib libjpeg-turbo libpng

ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/gsl/2.2.1-omkpbe2/include
gsl_EX_LIB := gsl gslcblas
gsl_EX_USE := root_cxxdefaults

ALL_TOOLS      += hdf5
hdf5_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/hdf5/1.8.17-omkpbe2/include
hdf5_EX_LIB := hdf5

ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/hector/1.3.4_patch1-gnimlf6/include
...
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/hepmc/2.06.07-omkpbe2/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/heppdt/3.03.00-omkpbe2/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig
herwig_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/herwig/6.521-gnimlf2/include
herwig_EX_LIB := herwig herwig_dummy
herwig_EX_USE := root_cxxdefaults f77compiler lhapdf photos

ALL_TOOLS      += herwigpp
herwigpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/herwigpp/7.1.4-gnimlf2/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/ittnotify/16.06.18-gnimlf/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/jemalloc/5.1.0/include
...
jimmy_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/jimmy/4.2-gnimlf2/include
jimmy_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/ktjet/1.06-gnimlf/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/lhapdf/6.2.1-gnimlf2/include
lhapdf_EX_LIB := LHAPDF
lhapdf_EX_USE := yaml-cpp root_cxxdefaults

ALL_TOOLS      += libffi
libffi_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libffi/3.2.1-omkpbe2/include
libffi_EX_LIB := ffi

ALL_TOOLS      += libhepml
libhepml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libhepml/0.2.1-omkpbe2/interface
libhepml_EX_LIB := hepml
libhepml_EX_USE := root_cxxdefaults

ALL_TOOLS      += libjpeg-turbo
libjpeg-turbo_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libjpeg-turbo/1.3.1-omkpbe2/include
libjpeg-turbo_EX_LIB := jpeg turbojpeg
libjpeg-turbo_EX_USE := root_cxxdefaults

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libpng/1.6.16-omkpbe2/include
libpng_EX_LIB := png
libpng_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libtiff/4.0.3-omkpbe2/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := root_cxxdefaults libjpeg-turbo zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libungif/4.1.4-omkpbe2/include
libungif_EX_LIB := ungif
libungif_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libuuid
libuuid_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libuuid/2.22.2-omkpbe2/include
libuuid_EX_LIB := uuid
libuuid_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libxml2/2.9.1-omkpbe2/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/libxslt/1.1.28-omkpbe4/include/libxslt
libxslt_EX_LIB := xslt
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/llvm/6.0.0-ogkkac/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/lwtnn/2.4-gnimlf4/include
lwtnn_EX_LIB := lwtnn
...
ALL_TOOLS      += mcdb
mcdb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mcdb/1.0.3-omkpbe2/interface
mcdb_EX_LIB := mcdb
mcdb_EX_USE := root_cxxdefaults xerces-c

ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mctester/1.25.0a-gnimlf6/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += md5
md5_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/md5/1.0.0-omkpbe2/include
md5_EX_LIB := cms-md5

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/meschach/1.2.pCMS1-omkpbe2/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mpfr-static/3.1.3-omkpbe2/include
mpfr_EX_LIB := mpfr

ALL_TOOLS      += mxnet-predict
mxnet-predict_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/mxnet-predict/1.2.1/include
mxnet-predict_EX_LIB := mxnetpredict
mxnet-predict_EX_USE := openblas

ALL_TOOLS      += numpy-c-api
numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/py2-numpy/1.14.1-gnimlf/c-api/core/include
numpy-c-api_EX_LIB := npymath

ALL_TOOLS      += openblas
openblas_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/OpenBLAS/0.2.20-omkpbe2/include
...
ALL_TOOLS      += openmpi
openmpi_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/openmpi/2.1.5/include
openmpi_EX_LIB := mpi mpi_cxx

ALL_TOOLS      += openssl
openssl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/openssl/1.0.2d-omkpbe2/include
openssl_EX_LIB := ssl crypto
openssl_EX_USE := root_cxxdefaults

ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/oracle/12.1.0.2.0-omkpbe/include
...
oracleocci_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cms_oracleocci_abi_hack/20180210-omkpbe/include
oracleocci_EX_LIB := cms_oracleocci_abi_hack
oracleocci_EX_USE := oracleocci-official

ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/pacparser/1.3.5-omkpbe2/include
pacparser_EX_LIB := pacparser
pacparser_EX_USE := root_cxxdefaults

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/pcre/8.37-omkpbe2/include
pcre_EX_LIB := pcre
...
photos_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/photos/215.5-omkpbe2/include
photos_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/photospp/3.61-omkpbe2/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/protobuf/3.5.2/include
...
py2-pybind11_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/py2-pybind11/2.2.3/include/python2.7
...
pythia6_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/pythia6/426-omkpbe2/include
pythia6_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/pythia8/230-gnimlf4/include
...
ALL_TOOLS      += python
python_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/python/2.7.14-omkpbe4/include/python2.7
python_EX_LIB := python2.7
python_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += python3
python3_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/python3/3.6.4-gnimlf/include/python3.6m
python3_EX_LIB := python3.6m
python3_EX_USE := sockets

ALL_TOOLS      += qd
qd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qd/2.3.13-omkpbe2/include
qd_EX_LIB := qdmod qd
...
ALL_TOOLS      += qt
qt_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/QtOpenGL /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/QtGui
qt_EX_LIB := QtOpenGL QtGui
qt_EX_USE := root_cxxdefaults qtbase qt3support x11 opengl

ALL_TOOLS      += qt3support
qt3support_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/Qt3Support
qt3support_EX_LIB := Qt3Support
qt3support_EX_USE := root_cxxdefaults qtbase
qt3support_EX_FLAGS_CPPDEFINES  := -DQT3_SUPPORT

ALL_TOOLS      += qtbase
qtbase_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/Qt /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/QtCore /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/QtXml
...
qtdesigner_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/qt/4.8.7-omkpbe2/include/QtDesigner
qtdesigner_EX_LIB := QtDesigner
qtdesigner_EX_USE := root_cxxdefaults qtbase qt

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/rivet/2.5.4-gnimlf6/include
rivet_EX_LIB := Rivet
...
roofitcore_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-gnimlf5/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-gnimlf5/include
root_interface_EX_USE := root_cxxdefaults

ALL_TOOLS      += rootcling
rootcling_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/lcg/root/6.12.07-gnimlf5/include
...
ALL_TOOLS      += self
self_EX_INCLUDE := /afs/hep.wisc.edu/user/vshang/public/tDM_nanoAOD/CMSSW_10_2_9/src/PhysicsTools/NanoAODTools/samples/CMSSW_10_2_15/src /afs/hep.wisc.edu/user/vshang/public/tDM_nanoAOD/CMSSW_10_2_9/src/PhysicsTools/NanoAODTools/samples/CMSSW_10_2_15/include/slc6_amd64_gcc700/src /afs/hep.wisc.edu/user/vshang/public/tDM_nanoAOD/CMSSW_10_2_9/src/PhysicsTools/NanoAODTools/samples/CMSSW_10_2_15/include/LCG /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_2_15/src /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_2_15/include/slc6_amd64_gcc700/src /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_2_15/include/LCG
self_EX_LIBDIR := /afs/hep.wisc.edu/user/vshang/public/tDM_nanoAOD/CMSSW_10_2_9/src/PhysicsTools/NanoAODTools/samples/CMSSW_10_2_15/lib/slc6_amd64_gcc700 /afs/hep.wisc.edu/user/vshang/public/tDM_nanoAOD/CMSSW_10_2_9/src/PhysicsTools/NanoAODTools/samples/CMSSW_10_2_15/external/slc6_amd64_gcc700/lib /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_2_15/lib/slc6_amd64_gcc700 /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/cmssw/CMSSW_10_2_15/external/slc6_amd64_gcc700/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/sherpa/2.2.6/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/sigcpp/2.6.2-omkpbe2/include/sigc++-2.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/sqlite/3.22.0-omkpbe/include
sqlite_EX_LIB := sqlite3
sqlite_EX_USE := root_cxxdefaults

ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/starlight/r193-gnimlf/include
...
tauola_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tauola/27.121.5-omkpbe2/include
tauola_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tauolapp/1.1.5-gnimlf4/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tbb/2018_U1-omkpbe2/include
tbb_EX_LIB := tbb
...
tensorflow_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tensorflow/1.6.0-gnimlf2/include

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/thepeg/2.1.4-gnimlf/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml
tinyxml_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tinyxml/2.5.3-gnimlf/include
tinyxml_EX_LIB := tinyxml

ALL_TOOLS      += tinyxml2
tinyxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tinyxml2/6.2.0/include
tinyxml2_EX_LIB := tinyxml2

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/tkonlinesw/4.2.0-1_gcc7-gnimlf6/include
...
toprex_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/toprex/4.23-omkpbe2/include
toprex_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/utm/utm_0.7.1-gnimlf/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/valgrind/3.13.0-omkpbe2/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/cms/vdt/0.4.0-gnimlf/include
...
vecgeom_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/vecgeom/v00.05.00-gnimlf/include
...
ALL_TOOLS      += vincia
vincia_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/vincia/2.2.01-gnimlf4/include
...
ALL_TOOLS      += xerces-c
xerces-c_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xerces-c/3.1.3-omkpbe2/include
xerces-c_EX_LIB := xerces-c
xerces-c_EX_USE := root_cxxdefaults

ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xrootd/4.8.3-gnimlf/include/xrootd /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xrootd/4.8.3-gnimlf/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdClient
xrootd_EX_USE := root_cxxdefaults

ALL_TOOLS      += xtensor
xtensor_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xtensor/0.15.4-gnimlf/include
xtensor_EX_USE := xtl

ALL_TOOLS      += xtl
xtl_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xtl/0.4.1-gnimlf/include

ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/xz/5.2.2-omkpbe2/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yaml-cpp
yaml-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/yaml-cpp/0.6.2-gnimlf/include
yaml-cpp_EX_LIB := yaml-cpp
yaml-cpp_EX_USE := boost

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/yoda/1.6.7-gnimlf6/include
yoda_EX_LIB := YODA
yoda_EX_USE := root_cxxdefaults

ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /cvmfs/cms.cern.ch/slc6_amd64_gcc700/external/zlib-x86_64/1.2.11-omkpbe2/include
zlib_EX_LIB := z
